...
class Web_scrapper:
    ...
    def ebay(self,name):
        ...
        for new_li in li:
            try:
                ...
                new_obj={'image':img_class,'discription':a_tag,'price':price_span}
    ...
    def walmart(self,name):
        ...
        for parent in art:
            try:
                ...
                newobj={'discription':discription,'image':img_src,'price':price}
                newarr.append(newobj)
            except Exception as e:
                pass
    ...
    def sastodeal(self,name):
        ...
        for parent in art:
            # try:
                ...
                newobj={'discription':discription,'image':img,'price':new_price}
                newarr.append(newobj)
            # except Exception as e:
            #     pass
    ...
    def gyapu(self,name):
        ...
        for i in parent:
            ...
            new_price = f'Rs {price}'
            newobj={'discription':name,'image':image_path,'price':new_price}
            newarr.append(newobj)
    ...
    def thulo(self,name):
        ...
        for i in child:
            ...
            new_price = f'Rs {price}'
            newobj={'discription':new_name,'image':image,'price':new_price}
            newarr.append(newobj)
    ...
    def all_data(self,name):
        new_obj=[self.daraz(name),self.sastodeal(name),self.gyapu(name),self.thulo(name),self.ebay(name),self.amazon(name)]
        return new_obj
...
class ObjectDetect:
    ...
    def output(self):
        ...
        new_path = os.path.join(ROOT_DIR,'ponds.jpeg')
        print(ROOT_DIR)
        preprocessed_image = self.prepare_image(new_path)
        predictions = self.mobile.predict(preprocessed_image)
